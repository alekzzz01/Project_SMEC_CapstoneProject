    ...
    <section class="px-8 py-12 space-y-6">
        ...
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <div class="space-y-4">
                <div class="breadcrumbs text-sm">
                    <ul>
                        ...
                        <li><a>Events</a></li>
                        <li><a class="line-clamp-1">Clash of Minds, Balance of Priorities!</a></li>
                    </ul>
                </div>

                <div class="flex items-center justify-between">
                    <h1 class="text-4xl font-semibold">Clash of Minds, Balance of Priorities!</h1>
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600">A battle of wit and wisdom unfolded as Grade 9 - St. Lorenzo Ruiz 🆚 Grade 10 - St. Ignatius of Loyola debated the topic:

                    "Extracurricular Activities Are Just as Important as Academic Performance."

                    Both teams delivered compelling arguments, showcasing critical thinking, eloquence, and teamwork! In the end, the results were a tie, proving that both academics and extracurriculars play a vital role in student growth and success. 🤝🏆

                    Hats off to our young debaters for an intense and insightful discussion! 👏✨

                    </p>

                    <p>#SMECIntramurals2025 #SMECat38 #UnleashingtheGEM</p>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <img src="../assets/images/w-1.jfif" alt="" class="w-full h-96 lg:h-[400px] object-cover rounded-2xl shadow-lg mb-1">
