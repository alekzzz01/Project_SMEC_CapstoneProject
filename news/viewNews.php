...
<body>
    ...
    <section class="px-8 py-4 space-y-6">


        <p class="px-4 py-2 rounded-md bg-gray-100 text-red-500 font-medium">News Update: <span class="font-normal text-gray-700 ml-1">Lorem ipsum </span> </p>

        <img src="../assets/images/samplebg.jpg" alt="" class="w-full h-96 lg:h-[700px] object-cover rounded-2xl shadow-lg">
        ...
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-6">
                        <p class=" text-gray-600">Department · <span>Sun April 7,2025</span></p>
            ...
            <div class="space-y-4">
                ...
                <p class="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel egestas dolor, nec dignissim metus. Donec augue elit, rhoncus ac sodales id, porttitor vitae est. Donec laoreet rutrum libero sed pharetra.
                ...
                <p class="p-2 font-medium border-l-4 border-red-500">News Update:</p>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <img src="../assets/images/samplebg.jpg" alt="" class="w-full h-96 lg:h-[400px] object-cover rounded-2xl shadow-lg mb-1">
