...
$address = $row['province'] . " " . $row['city'] . " " . $row['barangay'] . " " . $row['zip_code'];
                        ...
                        <form action="" class="space-y-6" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 w-full">
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input name="" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md outline-blue-600" readonly />
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input name="" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md outline-blue-600" readonly value="<?php echo $gender ?>" />
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input name="" type="date" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md outline-blue-600" readonly value="<?php echo $date_of_birth ?>" />
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input name="" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md outline-blue-600" readonly value="<?php echo $address ?>" />
