    ...
    <div class="max-w-7xl mx-auto py-14 px-4 lg:px-12 h-full space-y-7">
        ...
        <div class="bg-white rounded-2xl p-7">
            <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
                ...
                <button class="btn rounded bg-teal-700 hover:bg-teal-600 text-white">
            ...
            <div class=" relative">
                <div class="grid grid-cols-7 border-t border-gray-200 sticky top-0 left-0 w-full">
                    ...
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Monday</div>
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Tuesday</div>
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Wednesday</div>
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Thursday</div>
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Friday</div>
                    <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Saturday</div>
