    ...
    <div class="max-w-7xl mx-auto py-14 px-4 lg:px-12 h-full">
                    ...
                    <div class="grid grid-cols-1 gap-7 lg:grid-cols-3">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="rounded bg-green-200 p-4 mb-7 space-y-2 ">
                                <h1 class="font-extrabold text-3xl text-green-900">YUL GIBSON C. GARCIA</h1>   
                                <h2 class="text-green-900 font-medium">Class/Section Name: GRADE 9 - LAPIZ </h2>
                                <p >Adviser: Ms. Victoria O. Panganiban</p>
                                ...
                                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Grade"  checked="checked" />
                                    <div role="tabpanel" class="tab-content pt-6">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="border px-4 py-2 bg-green-100">Math</td>
                                                        <td class="border px-4 py-2 bg-green-100">90</td>
                                                        <td class="border px-4 py-2 bg-green-100">85</td>
                                                        <td class="border px-4 py-2 bg-green-100">80</td>
                                                        <td class="border px-4 py-2 bg-green-100">85</td>
                                                        <td class="border px-4 py-2 bg-green-100">85</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="border px-4 py-2 bg-green-100">English</td>
                                                        <td class="border px-4 py-2 bg-green-100">90</td>
                                                        <td class="border px-4 py-2 bg-green-100">85</td>
                                                        <td class="border px-4 py-2 bg-green-100">80</td>
                                                        <td class="border px-4 py-2 bg-green-100">85</td>
                                ...
                                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Behavior" />
                                    <div role="tabpanel" class="tab-content pt-6">
                                            <table >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="border px-4 py-2 bg-green-100">Maka-Diyos</td>
                                                        <td class="border px-4 py-2 bg-green-100">Expresses one's spiritual beliefs while respecting the spiritual beliefs of others</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">SO</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="border px-4 py-2 bg-green-100">Makakalikasan</td>
                                                        <td class="border px-4 py-2 bg-green-100">Is sensitive to individual, social and cultural differences Demonstrates contributions towards solidarity</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">AO</td>
                                                        <td class="border px-4 py-2 bg-green-100">SO</td>
                        ...
                        <div class="p-6 bg-white rounded-md border border-gray-200 space-y-3.5 col-span-1">
                            ...
                            <div>
                                <p class="text-sm font-light mb-1 ml-1 text-base-content/70">Name</p>
                                    ...
                                    <input name="grade-level" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md  bg-green-50" readonly value="YUL GIBSON C. GARCIA"  />
                            ...
                            <div>
                                <p class="text-sm font-light mb-1 ml-1 text-base-content/70">Grade Level</p>
                                    <div class="relative flex items-center">
                                    <input name="grade-level" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md  bg-green-50" readonly  />
                            ...
                            <div>
                                <p class="text-sm font-light mb-1 ml-1 text-base-content/70">Academic Year</p>
                                    <div class="relative flex items-center">
                                    <input name="first_name" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md  bg-green-50" readonly  />
