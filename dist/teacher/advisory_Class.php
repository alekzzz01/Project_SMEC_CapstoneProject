...
<body class="min-h-screen bg-[#f2f5f8]">
    ...
    <div class="max-w-7xl mx-auto py-14 px-4 lg:px-12 h-full ">
            ...
            <div class="rounded bg-green-200 p-4 mb-7 space-y-2">
                ...
                <h2 class="text-green-900 font-medium">Advisory Class</h2>
                <h1 class="font-extrabold text-3xl">Section Name: <span class="text-green-900">GRADE 9 - LAPIZ </span></h1>
                    ...
                    <table id="example" class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Section - A</td>
                                <td>
                                    <a href="view_Student.php" type='submit' name='approve' class='text-green-700 text-sm hover:underline'>[View]</a>
