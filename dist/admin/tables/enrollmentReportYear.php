    ...
    <div>
        ...
        <form method="GET" action="" class="pt-7">
            <div class="flex items-end gap-4">
                ...
                <button type="submit" class="btn btn-sm bg-blue-600 text-white">Filter</button>
        ...
        <div class="mt-7 p-7 bg-white rounded-2xl shadow overflow-auto">
                    ...
                    buttons: [
                        ...
                        // Copy
                        {
                            ...
                            title: function() {
                                ...
                                return 'Sta. Marta Educational Inc. | Enrollment report | All Academic Years';
                            },
