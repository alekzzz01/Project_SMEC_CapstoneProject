        ...
        <div class="p-6 bg-[#f2f5f8] h-full">
                ...
                <form class="p-6 bg-white rounded-md my-7 grid grid-cols-1 lg:grid-cols-2 gap-16" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="max-w-3xl  space-y-8 ">
                        ...
                        <div>
                        <button type="submit" name="submit" class="px-3 py-1 rounded-lg font-medium bg-blue-500 hover:bg-blue-700 text-white border border-blue-500 hover:border-blue-700">Save Changes</button>
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <form action="" method="POST">
                                ...
                                <div>
                                <button type="submit" name="removeLogo" class="px-3 py-1 rounded-lg font-medium bg-red-500 hover:bg-red-700 text-white border border-red-500 hover:border-red-700">Remove logo</button>
                                </div>
