        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5  mb-24">
                        ...
                        <div class="flex flex-wrap gap-4  p-6 bg-blue-50 rounded-md">
                            <img src="https://miro.medium.com/v2/resize:fit:791/0*Y4gR8kMGOPhG6bae.png" alt="" class="w-[100px] h-[100px]">
                            <div>
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 gap-10 lg:grid-cols-3 mb-24">
                ...
                <div class="space-y-3 bg-white shadow-md rounded-md">
                    <img src="https://scontent.fmnl30-2.fna.fbcdn.net/v/t39.30808-6/466625552_1103040391827790_7205700872014732523_n.jpg?stp=cp6_dst-jpg&_nc_cat=100&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeEuUaYuxeaJC7cLGrSzSeH8qVKCV__R-sapUoJX_9H6xjFF0hjMNyqGNLwadcpnle8V5Zh1QusgNXk8Rfnd1MdB&_nc_ohc=1kjzZSwNy-gQ7kNvgHurrFD&_nc_zt=23&_nc_ht=scontent.fmnl30-2.fna&_nc_gid=AdbeqHaehRVVkmIv698bzcq&oh=00_AYCAt-71levWOVTAdsQ6Cp9ZfWJzMr929_CFXNsQBy17zQ&oe=67548519" alt="" class="h-[300px] w-full object-cover rounded-t-md">
                    <div class="py-6 px-4 border-t border-gray-100">
                        <p class="text-lg font-bold mb-1">Awards and Recognition 1</p>
                        <p class="font-light text-gray-400 mb-10">6 November 2024</p>
                        <a href="" class=" text-sm bg-blue-500 hover:bg-blue-700 transition-colors py-2 px-4  text-white rounded-md">Read More</a>
                    </div>
                </div>

                <div class="space-y-3 bg-white shadow-md rounded-md">
                    <img src="https://scontent.fmnl30-2.fna.fbcdn.net/v/t39.30808-6/469070583_1117705550361274_2506153543749082211_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeHYp1oPpLy0Ytn7cYe01g8eYoViLQQkhhRihWItBCSGFOOIZs-7vQ_U3Kl8XjrAqJH0eArbFgGdNFZOyiPTHXaH&_nc_ohc=8zBOYr9-RloQ7kNvgHXnDPA&_nc_zt=23&_nc_ht=scontent.fmnl30-2.fna&_nc_gid=AfXMDFIGbCnMVAvMhSNG9D3&oh=00_AYCRk98V4klivbFn8pVQ5lVETFqKkjb53tQjb74bq6eAiQ&oe=6754AC54" alt="" class="h-[300px] w-full object-cover rounded-t-md">
                    <div class="py-6 px-4 border-t border-gray-100">
                        <p class="text-lg font-bold mb-1">Awards and Recognition 2</p>
                        <p class="font-light text-gray-400 mb-10">6 November 2024</p>
                        <a href="" class=" text-sm bg-blue-500 hover:bg-blue-700 transition-colors py-2 px-4  text-white rounded-md">Read More</a>
                    </div>
                </div>
                ...
                <div class="space-y-3 bg-white shadow-md rounded-md">
                    <img src="https://scontent.fmnl30-3.fna.fbcdn.net/v/t39.30808-6/469009022_1117704060361423_5619535443623292505_n.jpg?stp=cp6_dst-jpg_tt6&_nc_cat=104&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeHg_cv5uU59GAN6OPT7UuZHDn1gn7TSjE0OfWCftNKMTRaX_uDvn_c_BhWv1CQ2Rf-4urN-kwRJp0otxYRMTope&_nc_ohc=9ENmWyfSZeIQ7kNvgHEXL6Q&_nc_zt=23&_nc_ht=scontent.fmnl30-3.fna&_nc_gid=AL_yx-fLuC6mMajrbbBCm89&oh=00_AYD5zK4DPZD0Evh2APdWs7B_B4qhUkyVkvupysQW28ZAiw&oe=6754A8F3" alt="" class="h-[300px] w-full object-cover rounded-t-md">
                    <div class="py-6 px-4 border-t border-gray-100">
                        <p class="text-lg font-bold mb-1">Awards and Recognition 3</p>
                        <p class="font-light text-gray-400 mb-10">6 November 2024</p>
                        <a href="" class=" text-sm bg-blue-500 hover:bg-blue-700 transition-colors py-2 px-4  text-white rounded-md">Read More</a>
                    </div>
                </div>
