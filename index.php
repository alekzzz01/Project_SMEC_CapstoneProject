...
<body>
    ...
    <section class="relative h-[40vh] lg:h-[95vh] bg-[url('https://static1.squarespace.com/static/50afefd0e4b01c11f0ec0c82/t/5d916d9585b31035f10fd716/1572059893014/Learning-Landscape-Denver-Schools-Conservatory-Green%2B%283%29.jpg?format=1500w')] bg-no-repeat bg-cover bg-center flex items-center justify-center">
        
        <div class="absolute inset-0 bg-gradient-to-r from-black/75 to-black/20"></div>

        <button class="absolute left-5 btn btn-ghost  text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
            </svg>
        </button>

        <button class="absolute right-5 btn btn-ghost  text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="relative mx-auto w-full max-w-7xl">
            ...
            <div class="max-w-2xl hidden lg:block">
                <h1 class="text-4xl lg:text-6xl font-bold text-white mb-4 shadow-sm">Welcome to Sta. Marta Educational Center Inc.</h1>
                <p class="text-white">A world-class learning environment</p>   
            </div>
    ...
    <section class="py-24 px-4 border-b border-gray-100">
        <div class="grid items-center grid-cols-1 gap-12 lg:gap-0 lg:grid-cols-2 mx-auto max-w-7xl">
                    <div>
                        <h2 class="text-3xl lg:text-4xl font-bold mb-4">Contact Us</h2>
                        <p class="text-gray-400">Have a question? Reach out to us!</p>
                    </div>
                    ...
                    <form action="">
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative flex items-center">
                                <input name="email" type="text" required class="w-full text-gray-800 text-sm border border-slate-900/10 px-3 py-2 rounded-md outline-blue-600" placeholder="Message" />
                                </div>
                            </div>
                        </div>
