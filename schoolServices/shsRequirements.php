        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-100 ">
                <ul class="flex flex-wrap gap-2 -mb-px">
                    ...
                    <li class="me-2">
                        <a href="shsRequirements.php" class="inline-block p-3 text-blue-600  border-b-2 active border-blue-600 rounded-t-lg hover:text-blue-600 hover:border-blue-300 dark:hover:text-blue-300">Senior High School</a>
                    </li>
