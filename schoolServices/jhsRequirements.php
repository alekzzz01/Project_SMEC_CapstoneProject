            ...
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-100 ">
                    <ul class="flex flex-wrap gap-2 -mb-px">
                        ...
                        <li class="me-2">
                            <a href="elementaryRequirements.php" class="inline-block p-3 border-b-2 border-transparent rounded-t-lg hover:text-blue-600 hover:border-blue-300 dark:hover:text-blue-300">Elementary</a>
                        </li>

                        <li class="me-2">
                            <a href="jhsRequirements.php" class="inline-block p-3 text-blue-600  border-b-2 active border-blue-600 rounded-t-lg hover:text-blue-600 hover:border-blue-300 dark:hover:text-blue-300">Junior High School</a>
                        </li>
                ...
                <div class="space-y-3">
                        ...
                        <div class="collapse collapse-arrow join-item border-base-300 border-b pb-6">
                            ...
                            <img src="../assets/images/admission/qualifications.jfif" alt="">
                            </div>
                        </div>
                        <div class="collapse collapse-arrow join-item border-base-300 border-b py-6">
                            ...
                            <div class="collapse-content text-sm font-light text-gray-500">
                            <img src="../assets/images/admission/admission_requirements.jfif" alt="">
                            </div>
                        </div>
                        <div class="collapse collapse-arrow join-item border-base-300 border-b py-6">
                            <input type="radio" name="my-accordion-4" />
                            ...
                            <div class="collapse-content text-sm font-light text-gray-500">
                            <img src="../assets/images/admission/enrollment_process.jfif" alt="">
                            </div>
                        </div>
                        </div>
