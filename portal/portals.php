                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p class=" text-xl mb-6 mt-3 font-semibold">Online Enrollment</p>
                         ...
                         <a href="../student/enrollment/" class=" text-sm bg-blue-500 hover:bg-blue-700 transition-colors py-2 px-4  text-white rounded-md inline-flex items-center gap-2">
